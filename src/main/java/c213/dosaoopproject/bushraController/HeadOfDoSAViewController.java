...
public class HeadOfDoSAViewController {
    ...
    public void initialize() {
        ...
        loadSubView("/bushraView/user7/DashboardOverview.fxml", btnDashboard);
    }
    ...
    private void majorEventViewOA(ActionEvent event) {
        loadSubView("/bushraView/user7/MajorEventsView.fxml", btnPendingEventsCard);
    }

    @FXML
    private void budgetManagementOA(ActionEvent event) {
        loadSubView("/bushraView/BudgetManagementView.fxml", btnBudgetManagement);
    }

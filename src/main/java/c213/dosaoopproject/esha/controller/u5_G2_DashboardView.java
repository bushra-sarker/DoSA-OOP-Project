...
public class u5_G2_DashboardView
{
    ...
    @FXML
    private TableColumn estimatedAmountColumn;
    @FXML
    private Button refreshBtn;
    @FXML
    private TableColumn executiveIdColumn;
    @FXML
    ...
    private BudgetRow requireSelection() {
        BudgetRow selected = (BudgetRow) budgetTable.getSelectionModel().getSelectedItem();
        if (selected == null) {

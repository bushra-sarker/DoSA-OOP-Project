...
//    opens c213.dosaoopproject to javafx.base;
    opens c213.dosaoopproject.Nahin.utility to javafx.base;
    exports c213.dosaoopproject;
    opens c213.dosaoopproject.commonClass.model to javafx.base;
    opens c213.dosaoopproject.commonClass.controller to javafx.fxml;
    opens c213.dosaoopproject.commonClass.util to javafx.base;
    opens c213.dosaoopproject.commonClass.data to javafx.base;
